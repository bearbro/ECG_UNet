...
def SigSegmentationGenerator(sigs_path, segs_path, batch_size, n_classes, output_length=1800, class_value=[0, 0.5, 1]):
    ...
    while True:
        ...
        for _ in range(batch_size):
            ...
            Y.append(getSegmentationArr(seg, n_classes, output_length, class_value=class_value))
